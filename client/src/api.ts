...
export const api = {
  ...
  approvePreferences: (interestScores: Trip['groupPreference']['interestScores']) => request<{ trip: Trip }>('/api/planner/approve-preferences', { method: 'POST', body: JSON.stringify({ interestScores }) }),
